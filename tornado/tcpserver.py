...
class TCPServer(object):
    ...
    # 对listen socket加入到ioloop里面，然后绑定自己的handle_connection函数
    # 从目前的使用上面来看，主要都是用了一个listen socket，不觉得使用多个有啥用处？难道是监听多个端口？？
    ...
    def start(self, num_processes=1):
        ...
        self._started = True
        # 文档说在多核情况下会主动创建同等数量进程，但我这里没看到，好奇怪
        if num_processes != 1:
    ...
    # so the iostream interface hide connection detail, and offer stream interface for write and receive op
    #
